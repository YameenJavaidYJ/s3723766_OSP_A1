...
task2-d: 
	g++ -Wall -Werror -std=c++14 -g -O -o  Executables/Debug/Task2Debug  Functions/Utils.cpp Functions/TaskFilter.cpp  Functions/Map.cpp Functions/Reduce.cpp src/Task2/Task2.cpp
